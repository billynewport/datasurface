...
def main():
    ...
    if (initial_state['latest_customer'] and final_state['latest_customer'] and
        initial_state['latest_customer']['id'] != final_state['latest_customer']['id']):
        print(f"   ✅ New customer created: {final_state['latest_customer']['id']}")
        changes_detected = True
    
    # Check if latest address changed (indicating new addresses)
    if (initial_state['latest_address'] and final_state['latest_address'] and
        initial_state['latest_address']['id'] != final_state['latest_address']['id']):
