...
def defineTables(eco: Ecosystem, gz: GovernanceZone, t: Team):
    t.add(
        Datastore(
            "WWI_Data",
            documentation=PlainTextDocumentation("WWI_Data is a datastore that contains the Wide World Importers database"),
...
def defineWorkspaces(eco: Ecosystem, t: Team, locations: set[LocationKey], chooser: DataPlatformChooser, dp: DataPlatform):
    ...
    w: Workspace = Workspace(
        ...
        DatasetGroup(
            ...
            sinks=[
                DatasetSink("WWI_Data", "customers"),
                DatasetSink("WWI_Data", "orders"),
                DatasetSink("WWI_Data", "order_lines"),
                DatasetSink("WWI_Data", "invoices"),
                DatasetSink("WWI_Data", "invoice_lines"),
                DatasetSink("WWI_Data", "customer_transactions")
            ]
        ))
    t.add(w)
    ...
    w = Workspace(
        ...
        DatasetGroup(
            ...
            platform_chooser=chooser,
            sinks=[
                DatasetSink("WWI_Data", "stock_items"),
                DatasetSink("WWI_Data", "stock_item_holdings"),
                DatasetSink("WWI_Data", "stock_groups"),
                DatasetSink("WWI_Data", "stock_item_stock_groups"),
                DatasetSink("WWI_Data", "stock_item_transactions"),
                DatasetSink("WWI_Data", "suppliers"),
                DatasetSink("WWI_Data", "purchase_orders"),
                DatasetSink("WWI_Data", "purchase_order_lines")
            ]
        ))
    t.add(w)
    ...
    w = Workspace(
        ...
        DatasetGroup(
            ...
            sinks=[
                DatasetSink("WWI_Data", "customers"),
                DatasetSink("WWI_Data", "customer_categories"),
                DatasetSink("WWI_Data", "buying_groups"),
                DatasetSink("WWI_Data", "cities"),
                DatasetSink("WWI_Data", "state_provinces"),
                DatasetSink("WWI_Data", "countries")
            ]
        ),
        DataTransformer(
            "MaskCustomerData",
    ...
    w = Workspace(
        ...
        DatasetGroup(
            ...
            platform_chooser=chooser,
            sinks=[
                DatasetSink("WWI_Data", "vehicle_temperatures"),
                DatasetSink("WWI_Data", "cold_room_temperatures")
            ]
        ))
    t.add(w)
