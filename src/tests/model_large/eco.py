...
from tests.model_large.wwi import defineTables as defineWWITeamTables
from tests.model_large.wwi import defineWorkspaces as defineWWITeamWorkspaces
...
def createEcosystem() -> Ecosystem:
    ...
    # Read max index from the env variable MAX_INDEX
    max_index: int = int(os.getenv("MAX_INDEX", "50"))
    for index in range(1, max_index):
        # Add WWI tables and workspaces to the team
        defineWWITeamTables(ecosys, index, gz, team)
        ...
        defineWWITeamWorkspaces(ecosys, index, team, {LocationKey("MyCorp:USA/NY_1")}, chooser, ecosys.getDataPlatformOrThrow("YellowLive"))
