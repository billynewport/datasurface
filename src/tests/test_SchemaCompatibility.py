...
from datasurface.md import DDLTable, ValidationProblem

class TestSchemaCompatibility(unittest.TestCase):

    def assertCompatible(self, rc : Sequence[ValidationProblem]):
        self.assertEquals(len(rc), 0)

    def assertNotCompatible(self, rc : Sequence[ValidationProblem]):
        self.assertNotEquals(len(rc), 0)
    ...
    def test_ColumnCompatibility(self):
        ...
        self.assertCompatible(col1.isBackwardsCompatibleWith(col2))
        ...
        col1.type = String(15)
        self.assertNotCompatible(col1.isBackwardsCompatibleWith(col2))

        # Check String isn't compatible with IEEE32
        col1.type = IEEE32()
        self.assertNotCompatible(col1.isBackwardsCompatibleWith(col2))
        self.assertNotCompatible(col2.isBackwardsCompatibleWith(col1))
    ...
    def testDDLTableBackwardsCompatibility(self):
        ...
        self.assertCompatible(t2.isBackwardsCompatibleWith(t1))
        ...
        self.assertNotCompatible(t2.isBackwardsCompatibleWith(t1))
