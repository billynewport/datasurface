...
class TestDataStoreJSON(unittest.TestCase):
    ...
    def test_DataStoreJSON_from_json(self):
        ...
        schema = customers["originalSchema"]
        self.assertTrue("columns" in schema)
        ...
        contact_name = schema["columns"]["contact_name"]
        ...
        contact_title = schema["columns"]["contact_title"]
        ...
        address = schema["columns"]["address"]
        ...
        postal_code = schema["columns"]["postal_code"]
        ...
        country = schema["columns"]["country"]
    ...
    def test_WorkspaceJSON(self):
        ...
        workspaceJSON = workspace.to_json()
