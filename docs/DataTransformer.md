...
**PROBLEM HERE:** This would mean there are 2 output Datastores with the same name but generated by different DataPlatforms. One could be live and the other batch milestoned for example, they are different and not interchangeable. This is a problem. The DataPlatform should be able to provide a unique name for the output Datastore. This is a problem for the DataPlatform to solve.
