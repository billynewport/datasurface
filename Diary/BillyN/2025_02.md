...
I switched to cursor instead of vscode. The code level of cursor doesn't have the current bug in vscode which breaks venv support. The AI assistant seems better than copilot also.
