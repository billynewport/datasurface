...
Removing some redundancy in the PlatformPipelineGraph, I was tracking both exports and consumers when I can derive the exports from the consumers. This simplifies the code a little.
