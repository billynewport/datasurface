...
When I generate platform table/view names for datasets which have been ingested from a source with a dataset-table mapping, I'm using the mapping to make the downstream names which seems wrong.
