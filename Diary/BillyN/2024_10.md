...
I started this diary section in the project. I'm planning on having a markdown file for each month. I will use this to track my progress on the project and my thinking. This diary should be thought of as a stream of consciousness type of writing. It's not being edited after the fact or edited for consistency. The best way to consume this is likely by using an LLM to take it and summarize the current findings and surprises over time.

### Who am I?

I'm Billy Newport, currently retired and living in Florida. I learned to program in 6502 when I was 11 on an Apple II, then Basic, Pascal, Z80, a ZX Spectrum and then I went to college. During college I wrote commercial video games for 8 bit computers and 16 bit computers and published my own game Phantom Fighter on the Commodore Amiga. I then taught degree undergrads at WIT in Ireland. Next, I worked at Glockenspiel in Dublin, Ireland on the OSF/Motif of CommonView (the worlds first portable windowing SDK) on various unix workstations. Then I went contracting working in document workflow, document image workflow systems, travel reservation systems, mobile telco billing systems. I started work at IBM in 2001 working on WebSphere. I became a distinguished engineer in 2005. I created and ran the IBM WebSphere Extreme Scale product during my time there. I joined Goldman Sachs in mid 2011, became a managing director there in 2015 after my data lake platform went live. I retired from there in 2021. At GS, I built their data lake platform which ran forensic data warehousing for regulatory reporting at the firm. This system became a popular and critical system thats still used today. It grew explosively for the first 4 years at 4x per year and then slowed to steady state as it was optimized for purpose. My team and I learned a lot building, operating, stabilizing this system. This was a large system, a 1000 node hadoop cluster, millions of datasets, 30TB of ingested parquet data daily, over a peta byte daily of turned over parquet files and storing 4-6 petabytes in data total. Consumers queried data directly against HDFS as well as using DB2, Sybase IQ clusters (tens of 8 node iq clusters). But, HDFS was the authorative data store. 2 data centers with full duplicates for redundancy. I have lived and breathed this kind of system under fire for years. This project leverages my career experience to build a new data platform, DataSurface. It builts on my experience running these kinds of systems for years in a commercial environment. Datasurface makes it signficantly easier and cheaper to build and run these kinds of systems over multiple years. DataSurface embodies years of battle tested experience in this space.

DataSurface with the YellowDataPlatform allows an organization or a small team to stand up a scalable data platform for reporting or other uses from scratch in minutes. It's a metaplatform for data platforms. If you have a working kubernetes environment, you can stand up a data platform in minutes. This is documented [elsewhere](/docs/yellow_dp/HOWTO_Setup_YellowDataPlatform_Environment.md).
